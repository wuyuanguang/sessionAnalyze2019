...
//  */
//object ceshi extends Serializable{
//
//
//
//  def main(args: Array[String]): Unit = {
//    val conf = new SparkConf().setAppName(Constants.SPARK_APP_NAME_AD).setMaster("local[2]")
//    val sparkSession = SparkSession.builder().appName(Constants.SPARK_APP_NAME_AD).getOrCreate()
//    @transient
//   val ssc = new StreamingContext(conf, Seconds(5))
//    ssc.checkpoint("hdfs://hadoop2:8020/cp20190102")
//    //解析参数
//    //指定组名
//    val group = "group01"
//    val kafkaTopics = ConfigurationManager.getProperty(Constants.KAFKA_TOPICS)
//    val topicsSet = Set(kafkaTopics)
//    val brokerList = "192.168.91.4:9092,192.168.91.6:9092,192.168.91.7:9092"
...
//    ssc.checkpoint("hdfs://192.168.91.4:8020/cp20190106")
//    //获取黑名单并转化成RDD
//    val blackListRDD = getBlackListToRDD(ssc.sparkContext)
//   // 根据动态黑名单进行数据过滤
...
//    //业务二：计算每天各省的top3热门广告
//   calcuateProvinceTop3Ad(adRealTimeStatDStream,sparkSession)
...
//
//  }
//  def calcuateProvinceTop3Ad(adRealTimeStatDStream: DStream[(String, Long)],sparkSession: SparkSession) = {
